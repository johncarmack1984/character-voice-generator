  ...
  state: () =>
    ({
      traits: {
        ...
        Placement: ["Nose", "Throat", "Chest"],
        "Air Quality": ["Breathy", "Dry"],
        Age: ["Young", "Middle aged", "Old"],
        Gender: ["Woman", "Man", "Non-Binary person", "Agender person"],
        Size: ["Small", "Medium", "Large"],
        Tempo: ["Slow", "Medium", "Fast"],
        Volume: ["Quiet", "Medium Loud", "Loud"],
        Attitude: ["Friendly", "Impartial", "Agressive"],
        Accent: [
          "Texas",
          "Oklahoma",
          "Kentucky",
        ...
        "Vocal Issue": ["Raspy", "Lisp", "Mumbler", "None"],
      },
    } as StateTree),
  getters: {},
  actions: {
